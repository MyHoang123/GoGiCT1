...
function App() {
    ...
    async function login(Account) {
        try {
                ...
                if(response.data.massege === 'that bai') {
                    ...
                    cookies.set('AccessTokenAdmin', response.data.token, { path: '/', maxAge: 604800 }); // 604800 giây = 7 ngày
                    navigate('/admin')
                }
            } catch (error) {
    ...
    const handleSubMitLoginAdmin = (e) => {
        if(acc !== '' && pass !== '') {
            e.preventDefault()
            const Account = {
                Acc: acc,
    ...
    return ( 
        <>
            <div className={cx('header_body_card')}>
                        <div className={cx('header_body_card-grid')}>
                            <div className={cx('header_body_card-left')}>
                                ...
                                <div className={cx('header_body_card-lef_content_admin')}>
                                    <h1>Hello Admin</h1>
                                </div>
                            </div>
            ...
            <div className={cx('LoginAdmin_container')}>
                <div className={cx('LoginAdmin_container_content')}>
                    <div className={cx('container')}>
                            <div className={cx('left')}>
                                <form className={cx('form')} onSubmit={(e) => handleSubMitLoginAdmin(e)}>
                                    <div className={cx('input-block')}>
                                        <input onChange={(e) => setAcc(e.target.value)} value={acc} className={cx('input')} type="text" id="email" required=" "/>
                                        <label htmlFor="email">Username</label>
                                    </div>
                                    <div className={cx('input-block')}>
                                        <input onChange={(e) => setPass(e.target.value)} value={pass} className={cx('input')} type="password" id="pass" required=" "/>
                                        <label htmlFor="pass">Password</label>
                                    </div>
                                    <div className={cx('input-block')}>
                    <span className={cx('forgot')}><a href="#">Forgot Password?</a></span>
                                    <button>Submit</button>
                                </div>
                                </form>
                            </div>
                            <div className={cx('right')}>
                                <div className={cx('img')}><svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 731.67004 550.61784">
