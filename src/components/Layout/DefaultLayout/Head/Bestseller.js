                    ...
                    <>
                        <div className={cx('bestseller_item')}>
                            <div className={cx('card')}>
                                ...
                                <div className={cx('image_container')}>
                                    <img ref={e => imgBestSeller.current[0] = e} className={cx('image_animate_best')} src={`${process.env.REACT_APP_CALL_API}/api/v12/showimgproduct/${(products.length !== 0 ? (products[indexSlide[5]].Img) : (null))}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </div>
                        ...
                        <div className={cx('bestseller_item')}>
                            <div className={cx('card')}>
                                ...
                                <div className={cx('image_container')}>
                                    <img ref={e => imgBestSeller.current[1] = e} className={cx('image_animate_best')} src={`${process.env.REACT_APP_CALL_API}/api/v12/showimgproduct/${(products.length !== 0 ? (products[indexSlide[1]].Img) : (null))}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </div>
                                <div className={cx('title_card')}>
                        ...
                        <div className={cx('bestseller_item')}>
                            <div className={cx('card')}>
                                ...
                                <div className={cx('image_container')}>
                                    <img className={cx('image_animate_best')} ref={e => listProductBest.current[0] = e} src={`${process.env.REACT_APP_CALL_API}/api/v12/showimgproduct/${(products.length !== 0 ? (products[indexSlide[2]].Img) : (null))}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </div>
                                <div className={cx('title_card')}>
                        ...
                        <div className={cx('bestseller_item')}>
                            <div className={cx('card')}>
                                ...
                                <div className={cx('image_container')}>
                                    <img className={cx('image_animate_best')} ref={e => listProductBest.current[1] = e} src={`${process.env.REACT_APP_CALL_API}/api/v12/showimgproduct/${(products.length !== 0 ? (products[indexSlide[3]].Img) : (null))}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </div>
                                <div className={cx('title_card')}>
                        ...
                        <div className={cx('bestseller_item')}>
                            <div className={cx('card')}>
                                ...
                                <div className={cx('image_container')}>
                                    <img className={cx('image_animate_best')} ref={e => listProductBest.current[2] = e} src={`${process.env.REACT_APP_CALL_API}/api/v12/showimgproduct/${(products.length !== 0 ? (products[indexSlide[4]].Img) : (null))}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </div>
                                <div className={cx('title_card')}>
