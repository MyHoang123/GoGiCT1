...
// Cookie
    ...
    useEffect(() => {
        if(cookies.get('AccessToken') !== undefined) {
            axios.all([
                axios.get('https://severgogi.onrender.com/api/v12/showbestellerCategoris'),
                axios.post('https://severgogi.onrender.com/api/v12/showlengthcard',{token: cookies.get('AccessToken')}),
                axios.post('https://severgogi.onrender.com/api/v12/shownotifi',{token: cookies.get('AccessToken')}),
              ])
      ...
      useEffect(() => {
        if(cookies.get('AccessToken') !== undefined) {	
            if(socket !== null) {
                ...
                try {
                    const response = await axios.post('https://severgogi.onrender.com/api/v12/shownotifi',{token: cookies.get('AccessToken')})
        ...
        <div ref={btn} className={cx('navbar_content')}>
            ...
            <div className={cx('logo_gogi')} style={{pointerEvents:'none'}} >
                <div className={cx('logo_nav')}>
                    <img src={'https://severgogi.onrender.com/api/v12/header/logo-gogi-house-X5%20(1).png'} alt=""/>
                </div>
            </div>
    ...
    <div className={cx('slider')}>
        ...
        <div ref={image} className={cx('images')}>
            <div className={cx('item')} style={{'--i': 1}}>
                <img className={cx('Img_slide')} ref={(e) => imgProductSlide.current[5] = e} src={(products.length !== 0 ? (`https://severgogi.onrender.com/api/v12/bodyimg/${products[5].Img}`) : (null)) } />
            </div>
            <div className={cx('item')} style={{'--i': 2}}>
                <img className={cx('Img_slide')} ref={(e) => imgProductSlide.current[4] = e} src={(products.length !== 0 ? (`https://severgogi.onrender.com/api/v12/bodyimg/${products[4].Img}`) : (null)) } />
            </div>
            <div className={cx('item')} style={{'--i': 3}}>
                <img className={cx('Img_slide')} ref={(e) => imgProductSlide.current[3] = e} src={(products.length !== 0 ? (`https://severgogi.onrender.com/api/v12/bodyimg/${products[3].Img}`) : (null)) } />
            </div>
            <div className={cx('item')} style={{'--i': 4}}>
                <img className={cx('Img_slide')} ref={(e) => imgProductSlide.current[2] = e} src={(products.length !== 0 ? (`https://severgogi.onrender.com/api/v12/bodyimg/${products[2].Img}`) : (null)) } />
            </div>
            <div className={cx('item')} style={{'--i': 5}}>
                <img className={cx('Img_slide')} ref={(e) => imgProductSlide.current[1] = e} src={(products.length !== 0 ? (`https://severgogi.onrender.com/api/v12/bodyimg/${products[1].Img}`) : (null)) } />
            </div>
            <div className={cx('item')} style={{'--i': 6}}>
                <img className={cx('Img_slide_1')} ref={(e) => imgProductSlide.current[0] = e} src={(products.length !== 0 ? (`https://severgogi.onrender.com/api/v12/bodyimg/${products[0].Img}`) : (null)) } />
            </div>
        </div>
